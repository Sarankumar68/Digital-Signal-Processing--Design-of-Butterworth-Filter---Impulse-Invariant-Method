...
%enter the value of Ap0.8
%enter the value of As0.2
%enter the PB frequencypi/2
%enter the SB frequency0.7*pi
%enter the value of time0.5
```


## OUTPUT:

![WhatsApp Image 2026-04-01 at 3 42 53 PM (3)](https://github.com/user-attachments/assets/0add2af6-abb5-4b76-9514-bc32a5d041bc)


## RESULT:
![WhatsApp Image 2026-04-01 at 3 21 09 PM](https://github.com/user-attachments/assets/32575278-43a3-46b8-b8bb-51302b5b07cb)
